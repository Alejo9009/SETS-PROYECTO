...
type DetallePagoProps = {
  route: RouteProp<RootStackParamList, 'DetallePagoresi'>;
};

const  DetallePagoresi: React.FC<DetallePagoProps> = ({ route }) => {
...
export default DetallePagoresi;